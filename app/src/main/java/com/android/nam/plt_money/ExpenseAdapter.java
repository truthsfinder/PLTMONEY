...
public class ExpenseAdapter extends ArrayAdapter<String> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView tv_expense_date = (TextView) listViewItem.findViewById(R.id.expense_date);
        TextView tv_expense_amount = (TextView) listViewItem.findViewById(R.id.expense_amount);
        TextView tv_expense_category = (TextView) listViewItem.findViewById(R.id.expense_category);
